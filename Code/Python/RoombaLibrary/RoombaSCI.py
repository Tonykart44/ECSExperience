...
# 2016 Small modifications by Robin Amsters for roomba 620
...
class Buttons(object):
    ...
    dock = property(__dock)

#    def __power(self): #Does not work on roomba 620
#        x = self.data & 8
#        return bool(x > 0)
#
...
class RoombaAPI(object):
    ...
    def song(self, songNum, song = 'BEEP'):
        #Saves note to be played

        if song == 'BEEP':
            self.send_to_roomba([140,songNum,6,60,8,65,8,69,8,72,16,69,8,72,16])
